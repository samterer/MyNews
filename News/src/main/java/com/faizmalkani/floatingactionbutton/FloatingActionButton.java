...
public class FloatingActionButton extends View {
	...
	public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		shadowRadius = a.getFloat(R.styleable.FloatingActionButton_shadowRadius, 10.0f);
		shadowDx = a.getFloat(R.styleable.FloatingActionButton_shadowDx, 0.0f);
		shadowDy = a.getFloat(R.styleable.FloatingActionButton_shadowDy, 3.5f);
