...
public class NewsItemListViewAdapter1 extends RecyclerView.Adapter {
    ...
    public NewsItemListViewAdapter1(Context context, View.OnClickListener onClickListener) {
