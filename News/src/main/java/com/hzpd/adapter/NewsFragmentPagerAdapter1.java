...
import com.hzpd.ui.fragments.NewsItemFragment1;
...
public class NewsFragmentPagerAdapter1 extends FragmentVPAdapter<BaseFragment> {
    private int selectedPosition = 0;
    private HashMap<Integer, BaseFragment> fragmentMap = new HashMap<>(30);

    public NewsFragmentPagerAdapter1(FragmentManager fm) {
        super(fm);
    }
    ...
    BaseFragment getChannelFragment(NewsChannelBean ncb) {
        ...
        switch (ncb.getType()) {
            ...
            case NewsChannelBean.TYPE_SUBJECT:
                ...
                break;
            default:
                fragment = new NewsItemFragment1(ncb);
