...
public class InterfaceJsonfile {
	...
	public static final String FILE_ROOT = host1 + "/api.php?s=";

	public static final String MAGAZINE = host1 + "/api.php";
	...
	// 查看评论
	public static final String CHECKCOMMENT = PATH_ROOT + "/Comment/showcommentv2";
	// 发表评论
	public static final String PUBLISHCOMMENT = PATH_ROOT + "/Comment/setCommentv2";
	// 评论发表回复
