 ...
 */
public class InterfaceJsonfile_TW {


//    public static final String host1 = "http://221.130.163.77/99cms";
//    private static final String host2 = "http://221.130.163.77/99cms_jhxt";

    //台湾
    public static final String host1 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/dev/99cms";
    private static final String host2 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/dev/99cms_jhxt";

    //台湾
//    public static final String host1 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/tw/99cms";
//    private static final String host2 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/tw/99cms_jhxt";
//印尼
//    public static final String host1 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/id/99cms";
//    private static final String host2 = "http://ec2-52-76-26-225.ap-southeast-1.compute.amazonaws.com/id/99cms_jhxt";
    // ========================================
    public static final String PATH_ROOT = host2 + "/api.php?s=";
    public static String ROOT = host1 + "/";
    public static String FILE_ROOT = host1 + "/api.php?s=";

    public static String MAGAZINE = host1 + "/api.php";
    ...
    // 开屏图片
    public static final String mAdPic = ROOT + "api.php?s=/Version/getAdNew";
    // 缓存
    ...
    // 搜索
    public static final String SEARCH = ROOT + "api.php?s=/Search/getSearch";
    // 搜索
    public static final String SEARCH_TAG = ROOT + "api.php?s=/Search/tag";
    ...
    // 自浏览器打开获取新闻详情
    public static final String bnewsItem = ROOT + "api.php?s=/News/getNewsItem";
    // 自浏览器打开获取图集详情
    ...
    //
    public final static String API_DETAIL = MAGAZINE + "?s=/Magazine/api/api/article_view/id/";
    //
    // 发投诉爆料_添加图片
    ...
    //    FILE_ROOT
    public  static  final String News_Price=FILE_ROOT+"/Like/like";
