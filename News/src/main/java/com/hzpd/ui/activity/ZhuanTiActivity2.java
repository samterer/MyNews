...
public class ZhuanTiActivity2 extends MBaseActivity implements I_Control {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.special_detail_layout2);
...
//        mImageLoader.displayImage(img, zhuanti_header_iv);
        ...
        Log.i("nb.getTilte","nb.getTilte"+nb.getTitle());
