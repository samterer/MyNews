...
//			imgdetails_title_comment.setVisibility(View.VISIBLE);
	...
	class NewsAlbumAdapter extends RecyclingPagerAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			mImageLoader.displayImage(list.get(position).getSubphoto()
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.imgdetails_title_comment: {
				...
				intent.putExtra("id", imgListBean.getPid());
				intent.putExtra("mNewtype", "Album");
				LogUtils.i("nit-->" + imgListBean.getPid() + "  mBean.getLink()-->");
...
//				pop_ziti_img.setVisibility(View.GONE);
		...
		pop_fenxiang_img.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SharedUtil.showImgShares(true, null, imgListBean.getTitle(),
						imgPath, imgListBean.getPid(), NewsAlbumActivity.this);
			}
		});
...
//				}
		...
		pop_xiazai_iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				File img = App.getFile(sdPath + File.separator + "cyol" + File.separator + System.currentTimeMillis() + ".jpg");
