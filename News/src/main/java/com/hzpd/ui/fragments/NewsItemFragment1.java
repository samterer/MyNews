...
import com.hzpd.adapter.NewsItemListViewAdapter1;
...
public class NewsItemFragment1 extends BaseFragment implements I_Control, View.OnClickListener {
    @Override
    ...
    private NewsItemListViewAdapter1 adapter;
    ...
    public NewsItemFragment1() {

    }

    public NewsItemFragment1(NewsChannelBean channelbean) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        page = 1;
        isRefresh = true;
        View view = inflater.inflate(R.layout.news_channel_fragment1, container, false);
        update_counts = (TextView) view.findViewById(R.id.update_counts);
        layoutManager = new LinearLayoutManager(activity);
        mXListView.setLayoutManager(layoutManager);
        adapter = new NewsItemListViewAdapter1(activity, this);
