...
/** 
 * DAO for table "ZHUANTI_BEAN_DB".
*/
public class ZhuantiBeanDBDao extends AbstractDao<ZhuantiBeanDB, Long> {

    public static final String TABLENAME = "ZHUANTI_BEAN_DB";

    /**
     * Properties of entity ZhuantiBeanDB.<br/>
    ...
    */
    ...
    public ZhuantiBeanDBDao(DaoConfig config) {
        super(config);
    }
    
    public ZhuantiBeanDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ZHUANTI_BEAN_DB\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ZHUANTI_BEAN_DB\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ZhuantiBeanDB entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ZhuantiBeanDB readEntity(Cursor cursor, int offset) {
        ZhuantiBeanDB entity = new ZhuantiBeanDB( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ZhuantiBeanDB entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ZhuantiBeanDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ZhuantiBeanDB entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
