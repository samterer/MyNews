...
/** 
 * DAO for table "ALBUM_BEAN_DB".
*/
public class AlbumBeanDBDao extends AbstractDao<AlbumBeanDB, Long> {

    public static final String TABLENAME = "ALBUM_BEAN_DB";

    /**
     * Properties of entity AlbumBeanDB.<br/>
    ...
    */
    ...
    public AlbumBeanDBDao(DaoConfig config) {
        super(config);
    }
    
    public AlbumBeanDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALBUM_BEAN_DB\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ALBUM_BEAN_DB\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, AlbumBeanDB entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public AlbumBeanDB readEntity(Cursor cursor, int offset) {
        AlbumBeanDB entity = new AlbumBeanDB( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, AlbumBeanDB entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(AlbumBeanDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(AlbumBeanDB entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
