...
/** 
 * DAO for table "PUSH_BEAN_DB".
*/
public class PushBeanDBDao extends AbstractDao<PushBeanDB, Long> {

    public static final String TABLENAME = "PUSH_BEAN_DB";

    /**
     * Properties of entity PushBeanDB.<br/>
    ...
    */
    ...
    public PushBeanDBDao(DaoConfig config) {
        super(config);
    }
    
    public PushBeanDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PUSH_BEAN_DB\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PUSH_BEAN_DB\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PushBeanDB entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public PushBeanDB readEntity(Cursor cursor, int offset) {
        PushBeanDB entity = new PushBeanDB( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PushBeanDB entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PushBeanDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(PushBeanDB entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
