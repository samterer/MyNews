...
public class DonutProgress extends View {
	...
	public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		default_text_size = MyCommonUtil.sp2px(getResources(), 18);
		min_size = (int) MyCommonUtil.dp2px(getResources(), 100);
		default_stroke_width = MyCommonUtil.dp2px(getResources(), 10);
