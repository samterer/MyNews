...
public class PushBuilder extends BasicPushNotificationBuilder {
    ...
    public PushBuilder(Context context,String time) {
        super(context);
        this.time=time;
    }

    public PushBuilder(Context var1, int var2, int var4,String time) {
        super(var1);
        this.layout = var2;
    ...
    public PushBuilder(Context var1, int var2, int var3, int var4, int var5,int layoutTime,String time) {
        super(var1);
        this.layout = var2;
...
//        CalendarUtil.friendlyTime1(date,);
        ...
        var2.setTextViewText(R.id.time, ""+time);
