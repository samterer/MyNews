...
public class CustomSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            Log.e("test", "News: " + mRefreshing + ":" + mNotify);
            if (mRefreshing) {
    ...
    private void startScaleDownAnimation(Animation.AnimationListener listener) {
        ...
        mCircleView.setAnimationListener(listener);
        mCircleView.clearAnimation();
        Log.e("test", "News: mScaleDownAnimation");
    ...
    private Animation startAlphaAnimation(final int startingAlpha, final int endingAlpha) {
        ...
        mCircleView.clearAnimation();
        Log.e("test", "News: " + "startAlphaAnimation");
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        if (fast || isRefresh || isRefreshing()) {
            return false;
        }
    ...
    private void animateOffsetToCorrectPosition(int from, Animation.AnimationListener listener) {
        ...
        mCircleView.clearAnimation();
        Log.e("test", "News: mAnimateToCorrectPosition");
